...
public class HuntressScript : MonoBehaviour
{
    ...
    public void Shoot()
    {
        // Creates an arrow from our prefabs and gives it the position and rotation of the bow.
        GameObject currentArrow = Instantiate(arrow, tBow);
        // Remove the bow as the parent so the arrow can move irrespective of the bow.
        currentArrow.transform.parent = null;
        // Destroy arrow object after a time determined by the range.
        Destroy(currentArrow, fRange);
    }
}
