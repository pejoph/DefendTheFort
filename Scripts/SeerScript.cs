...
public class SeerScript : MonoBehaviour
{
    public float fPlayerSpeed;
    public GameObject fireball;
    public float fFireRate;
    public Transform tStaff;
    public float fRange;
    ...
    public void Cast()
    {
        // Creates a fireball from our prefabs and give it the position and rotation of the staff.
        GameObject currentFireball = Instantiate(fireball, tStaff);
        // Remove the staff as the parent so the fireball can move irrespective of the staff.
        currentFireball.transform.parent = null;
        // Destroy arrow object after 2 seconds.
        Destroy(currentFireball, fRange);
    }
}
